...
**Sub-elements:**
- `dui-checkbox-group` -- Props: `value` (string[] | undefined), `defaultValue` (string[]), `allValues` (string[]), `disabled` (boolean); Events: `value-change`; Slots: default
...
**Sub-elements:**
- `dui-radio` -- Props: `value` (string), `disabled` (boolean), `readOnly` (boolean); Slots: default; Parts: `root`, `dot`; Tokens: `--radio-size`
...
**Sub-elements:**
- `dui-alert-dialog-trigger` -- Slots: default
- `dui-alert-dialog-popup` -- Props: `keepMounted` (boolean), `initialFocus` (string | undefined), `finalFocus` (string | undefined); Slots: `title`, `description`, default; Parts: `backdrop`, `popup`, `title`, `description`
- `dui-alert-dialog-close` -- Slots: default
...
**Sub-elements:**
- `dui-dialog-trigger` -- Slots: default
- `dui-dialog-popup` -- Props: `keepMounted` (boolean), `initialFocus` (string | undefined), `finalFocus` (string | undefined), `width` (string | undefined); Slots: `title`, `description`, default; Parts: `backdrop`, `popup`, `title`, `description`
- `dui-dialog-close` -- Slots: default
...
**Parts:** `root`
**Sub-elements:**
- `dui-menu-item` -- Props: `disabled` (boolean); Theme attrs: `variant` ("default" | "danger"); Slots: default
...
**Sub-elements:**
- `dui-popover-trigger` -- Slots: default
- `dui-popover-popup` -- Props: `showArrow` (boolean), `closeOnClick` (boolean); Slots: default
- `dui-popover-close` -- Slots: default
...
**Sub-elements:**
- `dui-tooltip-trigger` -- Props: `disabled` (boolean); Slots: default
- `dui-tooltip-popup` -- Props: `showArrow` (boolean); Slots: default
...
**Sub-elements:**
- `dui-preview-card-trigger` -- Slots: default
- `dui-preview-card-popup` -- Props: `showArrow` (boolean); Slots: default; Tokens: `--preview-card-popup-padding`
...
**Sub-elements:**
- `dui-command-input` -- Props: `placeholder` (string)
- `dui-command-list` -- Slots: default
- `dui-command-group` -- Props: `heading` (string); Slots: default
- `dui-command-item` -- Props: `value` (string), `keywords` (string[]), `disabled` (boolean); Slots: default
- `dui-command-empty` -- Slots: default
- `dui-command-separator`
- `dui-command-shortcut` -- Slots: default
...
**Sub-elements:**
- `dui-accordion-item` -- Props: `value` (string), `disabled` (boolean); Events: `open-change`; Slots: `trigger`, default; Parts: `item`, `trigger`, `indicator`, `panel`, `content`
...
**Sub-elements:**
- `dui-tabs-list` -- Slots: default; Parts: `list`
- `dui-tab` -- Props: `value` (string), `disabled` (boolean); Slots: default; Parts: `tab`
- `dui-tabs-panel` -- Props: `value` (string), `keepMounted` (boolean); Slots: default; Parts: `panel`
- `dui-tabs-indicator`
...
**Parts:** `root`
**Sub-elements:**
- `dui-breadcrumb-item` -- Slots: default
- `dui-breadcrumb-link` -- Slots: default
- `dui-breadcrumb-page` -- Slots: default
- `dui-breadcrumb-separator` -- Slots: default
- `dui-breadcrumb-ellipsis` -- Slots: default
...
**Sub-elements:**
- `dui-sidebar` -- Slots: default
- `dui-sidebar-trigger` -- Slots: default
- `dui-sidebar-content` -- Slots: default
- `dui-sidebar-header` -- Slots: default
- `dui-sidebar-footer` -- Slots: default
- `dui-sidebar-group` -- Slots: `label`, default
- `dui-sidebar-group-label` -- Slots: default
- `dui-sidebar-menu` -- Slots: default
- `dui-sidebar-menu-item` -- Slots: default
- `dui-sidebar-menu-button` -- Props: `active` (boolean), `disabled` (boolean), `tooltip` (string), `href` (string | undefined); Theme attrs: `size` ("default" | "sm" | "lg"); Events: `spa-navigate`; Slots: `icon`, default, `suffix`
- `dui-sidebar-separator`
- `dui-sidebar-inset` -- Slots: default
...
These are set on `:root` by the token stylesheet and affect all components:
