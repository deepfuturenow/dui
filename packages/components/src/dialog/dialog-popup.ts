...
export class DuiDialogPopup extends LitElement {
  static tagName = "dui-dialog-popup" as const;
  ...
  @property()
  accessor width: string | undefined = undefined;
  ...
  override willUpdate(changed: PropertyValues): void {
    if (changed.has("width")) {
      if (this.width) this.style.setProperty("--popup-width", this.width);
      else this.style.removeProperty("--popup-width");
    }
