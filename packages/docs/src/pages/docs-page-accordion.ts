...
export class DocsPageAccordion extends LitElement {
  ...
  override render() {
    return html`
      <docs-page-layout
        tag="dui-accordion"
        .additionalTags=${["dui-accordion-item"]}
      >
        ...
        <dui-docs-demo label="Multiple mode" demo-width="25rem">
          <dui-accordion multiple default-value='["m-1","m-2"]'>
            ...
            <dui-accordion-item value="m-2">
              ...
              Ullamco minim amet sint excepteur aute aliqua quis ut officia id.
              Sit irure esse non eiusmod nisi. Lorem irure consectetur
              adipisicing cillum. Sit voluptate dolore irure occaecat minim
              tempor do mollit dolor cillum excepteur reprehenderit. Voluptate
              laborum culpa excepteur dolor occaecat duis commodo commodo. Magna
              nulla eiusmod labore cillum qui ullamco dolore adipisicing eu
              ipsum magna ut ullamco.
            </dui-accordion-item>
