...
export class DocsPageCheckbox extends LitElement {
  ...
  override render() {
    return html`
      ...
      <docs-page-layout
        tag="dui-checkbox"
        .additionalTags=${["dui-checkbox-group"]}
      >
        <dui-docs-demo label="States" demo-width="12rem">
          <div class="wrapper">
        ...
        <dui-docs-demo label="Group" demo-width="12rem">
          <dui-checkbox-group>
        ...
        <dui-docs-demo label="Group with select all" demo-width="12rem">
        ...
        <dui-docs-demo label="Disabled group" demo-width="12rem">
