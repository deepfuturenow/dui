...
const NAV_GROUPS: { label: string; slugs: string[] }[] = [
  {
    ...
    slugs: [
      ...
      "switch", "tabs", "textarea", "toast", "toggle", "toggle-group", "toolbar",
      "tooltip", "tree",
    ],
  },
  {
      ...
      <header class="top-bar">
        <div class="top-bar-left">
          ...
          <nav class="top-bar-nav">
            ...
            <a class="top-bar-link" href="https://deepfuturenow.github.io/dui-primitives" target="_blank">
              Primitives ↗
            </a>
          </nav>
        </div>
  ...
  #renderPage() {
    ...
    if (section === "components" && component) {
      switch (component) {
        ...
        case "toast": return html`<docs-page-toast></docs-page-toast>`;
